  ...
  return (
    <div className="pt-32 section-padding">
      <div className="container-narrow">
        ...
        <h1 className="font-display text-display-lg font-semibold text-ink mt-6">See</h1>
        <p className="font-body text-stone mt-4">Videos on YouTube. Empowerment and Access Consciousness insights.</p>
