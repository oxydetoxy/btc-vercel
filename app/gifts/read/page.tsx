  ...
  return (
    <div className="pt-32 section-padding">
      <div className="container-narrow">
        ...
        <h1 className="font-display text-display-lg font-semibold text-black mt-6">Read</h1>
        <p className="font-body text-black/60 mt-4">Books and written resources. Explore the Be The Change book and more.</p>
